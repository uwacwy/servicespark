...
<div class="row frm coordinator edit time">
	<div class="col-md-3">
		<?php echo $this->Element('coordinator_time_actions.ctp'); ?>
	</div>
	<div class="col-md-9">
		<?php 
		...
		?>
			...
			<?php debug($time['Event']); ?>
			<?php
				echo $this->Form->input('time_id');
				echo $this->Form->input('start_time');
				echo $this->Form->input('stop_time');
				echo "<hr>";
				echo $this->Form->input('Time.stop_time.null', array('type'=>'checkbox', 'label' => 'Check this box to blank the stop time.'))
			?>
