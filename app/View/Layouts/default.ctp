...
<head>
	...
	<meta name="google-site-verification" content="jicV-bcVSeXg2ULyYXWnj770AefLi_ZGxE8thQ4Duic" />
	<?php		
		echo $this->Html->css('autocomplete.css?ver=2018-03-02');
		echo $this->Html->css('servicespark.css?ver=2018-03-02');
		echo $this->Html->css('todo.css?ver=2018-03-02');
		...
		//echo $this->Html->script('dist/Vendor.bundle.js');
		echo $this->Html->script('dist/ServiceSpark.bundle.js');
