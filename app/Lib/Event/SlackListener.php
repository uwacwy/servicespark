...
class SlackListener implements CakeEventListener
{
	...
	public function implementedEvents()
	{
		return array(
			...
			'App.Rsvp.afterSave.created' => 'rsvp_saved',
			'App.Rsvp.afterSave.modified' => 'rsvp_saved',
	...
	public function rsvp_saved($cake_event)
	{
		...
		$verb = $rsvp['Rsvp']['status'] == 'going' ? 'attending' : 'not attending';
		
		$this->slack(
			__("%s is %s %s", $rsvp['User']['full_name'], $verb, $rsvp['Event']['title'] )
		);
	}
